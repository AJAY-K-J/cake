        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <return-purchase :vendors = "<?php echo e(json_encode($vendors)); ?>" :products = "<?php echo e(json_encode($products)); ?>" ></return-purchase>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cake\resources\views/admin/purchases.blade.php ENDPATH**/ ?>