...
<?php $__env->startSection('content'); ?>
    ...
    <section>
            ...
            :companies = "<?php echo e(json_encode($companies)); ?>" :payment_types = "<?php echo e(json_encode($payment_types)); ?>"></today-invoices>
        </section>
    </div>
    <div class="container">
    </div>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <return-sale  :products = "<?php echo e(json_encode($products)); ?>" ></return-sale>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <add-invoice :company_id="<?php echo e(json_encode(Input::get('company_id'))); ?>" :products = "<?php echo e(json_encode($products)); ?>"
                      :companies = "<?php echo e(json_encode($companies)); ?>"   :payment_types = "<?php echo e(json_encode($payment_types)); ?>"></add-invoice>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cake\resources\views/admin/invoices.blade.php ENDPATH**/ ?>