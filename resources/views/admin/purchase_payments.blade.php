...
@section('content')
	...
	<div class="container-fluid">
		...
		<section>
			<purchasepayments :purchase="{{ $purchase }}" :payment_types="{{ $payment_types }}"></purchasepayments>
		</section>
	</div>
	<div class="container">
	</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<add-purchasepayment :purchase="{{ $purchase }}" :payment_types="{{ $payment_types }}"></add-purchasepayment>
				</div>
			</div>
		</div>
	</div>
