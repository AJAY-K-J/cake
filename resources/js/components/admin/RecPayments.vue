            ...
            <div class="card-body">
                ...
                <h5 class="row">
                    <div class="col-md-4 mb-6">
                        <b>Receipt NO :</b> {{ sale.receipt_no }}
                    </div>
                    <div class="col-md-4 mb-2">
                        <b>Name :</b> {{ sale.customer_name }}
                    </div>
                    <div class="col-md-4 mb-2">
                        <b>Mobile :</b> {{ sale.mobile }}
                    </div>
                    <div class="col-md-4 mb-2">
                        <b>Total Payable :</b> {{ sale.total_net_amount }}
                    </div>
                    <div class="col-md-4 mb-2">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <add-rec_payment :sale="sale" :payment_types="payment_types" type="edit"></add-rec_payment>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    computed: {
        ...
        balance() {
            return (parseFloat(this.sale.total_net_amount) - parseFloat(this.total_paid)).toFixed(2);
        },
    },
    ...
    methods : {
        ...
        get_payments() {
            this.loading = true;
            axios.post('/rec_payments/get', {
                receipt_no: this.sale.receipt_no,
        ...
        delete_payment(id) {
            ...
            .then((willDelete) => {
                if(willDelete)
                {
                    axios.post('/rec_payments/delete',{
                        id: id  
                    })
                    .then(response => {
                        swal.stopLoading();
