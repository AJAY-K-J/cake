			...
			<div class="card-body">
				...
				<h5 class="row">
				    <div class="col-md-4 mb-6">
						<b>Purchase NO :</b> {{ purchase.id }}
					</div>
					<div class="col-md-4 mb-2">
						<b>Vendor Name :</b> {{ purchase.vendor.name }}
					</div>
					<div class="col-md-4 mb-2">
						<b>Mobile :</b> {{ purchase.vendor.mobile_no }}
					</div>
					<div class="col-md-4 mb-2">
						<b>Total Payable :</b> {{ purchase.amount }}
					</div>
					<div class="col-md-4 mb-2">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<add-purchasepayment :purchase="purchase" :payment_types="payment_types" type="edit"></add-purchasepayment>
					</div>
				</div>
			</div>
		</div>
...
export default {
	...
	computed: {
		...
		balance() {
			return (parseFloat(this.purchase.amount) - parseFloat(this.total_paid)).toFixed(2);
		},
	},
	...
	methods : {
		...
		get_payments() {
			...
			axios.post('/purchase_payments/get', {
		...
		delete_payment(id) {
			...
			.then((willDelete) => {
				if(willDelete)
				{
					axios.post('/purchase_payments/delete',{
						id: id  
					})
					.then(response => {
						swal.stopLoading();
